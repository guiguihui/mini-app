	...
	<view class="content">
		<uni-forms :rules="rules" validate-trigger="bind" class="login_from">
			...
			<uni-forms-item class="login_from_input" name="userPassword">
				...
				<view class="login_from_fun"><input type="text" v-model="user.userPassword" password="true"
						placeholder="请输入密码"></view>
			</uni-forms-item>

			<uni-forms-item class="login_from_input">
				<view class="login_from_name">确认密码</view>
				<view class="login_from_fun"><input type="text" v-model="user.userPassword2" password="true"
